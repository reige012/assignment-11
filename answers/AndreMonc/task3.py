...
"""
My comprehensive letter-based file-making program
...
a pair of words and word counts) and writing the words that start with the same
letter (along with their respective word counts) to 26 new files. I avoid
making a dictionary so that I maintain word sorting from most common to least
common.
